...
test("item add/delete", function(){
    ...
    equal(testList.addItem(""),undefined);
...
test("user action", function(){
    ...
    equal($("#todoList").html(),'<li><div class="item-text"><input type="checkbox">test item</div><a class="deleteItem" href="#">del</a><div style="clear:both;"></div></li>');
